...
list(
    ...
    list(
        tarchetypes::tar_download(tg_e950ce9d_5743_4901_91bd_a6d7e4a1fd55_Schema_PDF,
        ...
        tar_target(tg_e950ce9d_5743_4901_91bd_a6d7e4a1fd55_hydrology,
            {
                prc_atlas_of_canada_hydrology(
                    output_path = "workspace/data/harvested/atlas_of_canada_hydrology-1.0.0/processed",
                    input_files = list(
                        tg_e950ce9d_5743_4901_91bd_a6d7e4a1fd55_Waterbodies_GDB,
    ...
    list(tar_target(tg_d7a59fef_4cd1_4941_bea6_70d84ae53a5d_canada_outline,
        {
            prc_canada_outline(
                output_path = "workspace/data/harvested/canada_outline-1.0.0/processed",
                input_files = list()
            )
    ...
    list(tar_target(tg_e36167b9_1aa9_499b_a242_e9e85b7479cb_FishBase_Freshwater_Species,
        {
            extract_tables_from_url(
                urls = "https://www.fishbase.se/country/CountryChecklist.php?what=list&trpp=50&c_code=124&csub_code=&cpresence=present&sortby=alpha2&vhabitat=fresh",
        ...
        format = "file"
    ), tar_target(tg_e36167b9_1aa9_499b_a242_e9e85b7479cb_freshwater_fish_species_canada,
        {
            prc_freshwater_fish_canada(
    ...
    list(tar_target(tg_d1c88f68_2fd3_4f3d_afd1_431a4f0630e0_Freshwater_Fish_Species_Occurrences,
        ...
        format = "file"
    ), tar_target(tg_d1c88f68_2fd3_4f3d_afd1_431a4f0630e0_freshwater_fish_occurrences,
        {
            prc_freshwater_fish_occurrences(
            ...
            c(
                "workspace/data/harvested/freshwater_fish_occurrences-1.0.0/processed/bassins.gpkg",
                "workspace/data/harvested/freshwater_fish_occurrences-1.0.0/processed/occurrences.csv"
            )
        },
        format = "file"
    )) # ,
    # list(tar_target(tg_8dac83b6_9c80_4faa_ab5a_8e351d9c55fc_gbif,
    # {
    #     dwn_gbif(output_path = "workspace/data/analyzed/gbif-1.0.0",
    #         input_files = list(tg_e36167b9_1aa9_499b_a242_e9e85b7479cb_freshwater_fish_species_canada))
    #     "workspace/data/analyzed/gbif-1.0.0/metadata.json"
    # }, format = "file"))
)
