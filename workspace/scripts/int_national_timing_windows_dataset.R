int_national_timing_windows_dataset <- function(input_files, output_path) {
  ...
  dm::dm_from_con(con) |>
    ...
    dm::dm_add_fk(table = "migration_phenology", "species_id", "species") |>
    dm::dm_add_fk(table = "spawning_phenology", "species_id", "species") |>
    dm::dm_add_fk(table = "larvae_phenology", "species_id", "species") |>
    dm::dm_add_fk(table = "habitat_adult", "species_id", "species") |>
    dm::dm_add_fk(table = "habitat_juvenile", "species_id", "species") |>
    dm::dm_add_fk(table = "habitat_spawning", "species_id", "species") |>
    dm::dm_add_fk(table = "habitat_yoy", "species_id", "species") |>
    dm::dm_add_fk(table = "food_items", "species_id", "species") |>
    dm::dm_add_fk(table = "spawning", "species_id", "species") |>
    dm::dm_add_fk(table = "eggs", "species_id", "species") |>
    dm::dm_add_fk(table = "larvae", "species_id", "species") |>
    dm::dm_add_fk(table = "migration", "species_id", "species") |>
    dm::dm_add_fk(table = "morphology", "species_id", "species") |>
    dm::dm_add_fk(table = "tolerance_adult", "species_id", "species") |>
    dm::dm_add_fk(table = "tolerance_embryo", "species_id", "species") |>
    dm::dm_add_fk(table = "tolerance_larvae", "species_id", "species") |>
    dm::dm_add_fk(table = "tolerance_spawner", "species_id", "species") |>
